...
/**
 * Testet die Klasse {@link PasswordChecker}. Diese Tests sind dazu gedacht, dass Sie die Funktionalität von Strings an
 * der Klasse {@link PasswordChecker} lernen können, ohne selbst Tests zu schreiben. Wenn Sie zusätzlich das Testen aus
 * der letzten Vorlesung üben wollen, sollten Sie diese Tests ignorieren, und Ihre eigenen in der Klasse
 * {@link PasswordCheckerTest} schreiben. Diese können Sie auf Basis der Spezifikation vorher schreiben, oder hinterher,
 * wenn Sie im Nachgang Ihre Klassen testen wollen.
 *
 * @author Ullrich Hafner
 */
class PasswordCheckerAbnahmeTest {
